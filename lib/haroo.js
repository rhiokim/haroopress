...
//    var archiveFiles = direc.sort(conf.sourceDir +'/articles', 'mtime'),
    ...
    function datelize(archive) {
        ...
        archive._printDate = moment(archive.published).format('mm:ssa, Do MMM YYYY');
