...
CPPPATH_NODE = '/Users/kimyangwon/.nvm/v0.8.8/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/kimyangwon/node_modules'
LIBPATH_NODE = '/Users/kimyangwon/.nvm/v0.8.8/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CC = ['/usr/bin/gcc']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/kimyangwon/node_modules'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/kimyangwon/.nvm/v0.8.8'
